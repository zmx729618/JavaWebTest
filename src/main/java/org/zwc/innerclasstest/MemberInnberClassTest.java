 ...
 */
public class MemberInnberClassTest {
    ...
    class Inner {
        ...
        void inner_f1() {
            ...
            System.out.println(MemberInnberClassTest.this.j);
    ...
    public static void outer_f4() {
        // step1 建立外部类对象
        MemberInnberClassTest out = new MemberInnberClassTest();
    ...
    public static void main(String[] args) {
        ...
        // 那就不需要对其外围类对象的引用。
        MemberInnberClassTest out = new MemberInnberClassTest();
        MemberInnberClassTest.Inner outin = out.new Inner();
        outin.inner_f1();
    }
